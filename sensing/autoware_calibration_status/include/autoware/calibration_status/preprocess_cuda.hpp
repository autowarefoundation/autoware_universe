...
#ifndef AUTOWARE__CALIBRATION_STATUS__PREPROCESS_CUDA_HPP_
#define AUTOWARE__CALIBRATION_STATUS__PREPROCESS_CUDA_HPP_
...
#endif  // AUTOWARE__CALIBRATION_STATUS__PREPROCESS_CUDA_HPP_
