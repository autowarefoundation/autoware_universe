...
#ifndef AUTOWARE__CALIBRATION_STATUS__VISIBILITY_CONTROL_HPP_
#define AUTOWARE__CALIBRATION_STATUS__VISIBILITY_CONTROL_HPP_
...
#endif  // AUTOWARE__CALIBRATION_STATUS__VISIBILITY_CONTROL_HPP_
