...
#ifndef AUTOWARE__CALIBRATION_STATUS__ROS_UTILS_HPP_
#define AUTOWARE__CALIBRATION_STATUS__ROS_UTILS_HPP_
...
#endif  // AUTOWARE__CALIBRATION_STATUS__ROS_UTILS_HPP_
