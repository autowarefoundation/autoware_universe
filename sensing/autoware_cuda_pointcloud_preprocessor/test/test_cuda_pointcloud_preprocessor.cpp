...
TEST(CudaPointcloudPreprocessor, AcceptsValidCapacities)
{
...
TEST(CudaPointcloudPreprocessor, ProcessesPointsAtRingCapacityBoundary)
{
...
TEST(CudaPointcloudPreprocessor, ReportsRingIndexOverflow)
{
...
TEST(CudaPointcloudPreprocessor, ReportsPointsPerRingOverflow)
{
...
TEST(CudaPointcloudPreprocessor, TruncatesInputCloudToConfiguredMaximum)
{
