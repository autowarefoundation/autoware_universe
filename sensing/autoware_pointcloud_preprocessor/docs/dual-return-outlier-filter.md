...
Therefore, in order to use this node, the sensor driver must publish custom data including `return_type`. please refer to [PointXYZIRCAEDT](https://github.com/autowarefoundation/autoware_core/blob/59f1e190b933eaf61fc765ba0db575d795fb8e19/common/autoware_point_types/include/autoware/point_types/types.hpp#L95-L116) data structure.
...
Input data must be [PointXYZIRCAEDT](https://github.com/autowarefoundation/autoware_core/blob/59f1e190b933eaf61fc765ba0db575d795fb8e19/common/autoware_point_types/include/autoware/point_types/types.hpp#L95-L116) type data including `return_type`.
