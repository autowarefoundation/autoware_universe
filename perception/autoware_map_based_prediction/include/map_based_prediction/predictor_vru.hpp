...
public:
  ...
  void setParameters(
    ...
    double min_crosswalk_user_on_road_distance, bool use_crosswalk_signal,
    ...
    double crossing_intention_duration, double no_crossing_intention_duration)
  {
    ...
    min_crosswalk_user_on_road_distance_ = min_crosswalk_user_on_road_distance;
...
private:
  ...
  double min_crosswalk_user_on_road_distance_;
