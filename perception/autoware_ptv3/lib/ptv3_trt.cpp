  ...
  const bool should_run_seg3d)
{
  ...
  if (!encoder_trt_ptr_->setInputShape("serialized_code", nvinfer1::Dims{2, {2, num_voxels_}})) {
    RCLCPP_ERROR(rclcpp::get_logger("ptv3"), "Failed to set serialized_code input shape.");
    return false;
  }
