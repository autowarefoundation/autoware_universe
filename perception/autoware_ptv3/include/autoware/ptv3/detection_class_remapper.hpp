...
#ifndef AUTOWARE__PTV3__DETECTION_CLASS_REMAPPER_HPP_
#define AUTOWARE__PTV3__DETECTION_CLASS_REMAPPER_HPP_
...
public:
   ...
   */
  void map_classes(std::vector<Box3D> & boxes);
...
#endif  // AUTOWARE__PTV3__DETECTION_CLASS_REMAPPER_HPP_
