...
public:
   ...
   */
  void setParameters(const NMSParams & params);
...
private:
  [[nodiscard]] bool isTargetPairObject(
    const DetectedObject & object1, const DetectedObject & object2) const;
  Eigen::MatrixXd generateIoUMatrix(const std::vector<DetectedObject> & input_objects);
