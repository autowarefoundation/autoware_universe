...
| `model_params.score_thresholds.upper_bounds` | list[double] | [50.0, 90.0, 121.0, 200.0]                                                                                               | Upper bounds for each distance bucket. The ranges start from 0.0 and must be in ascending order. By default, the buckets are defined as **[0.0, 50.0)**, **[50.0, 90.0)**, **[90.0, 121.0)**, and **[121.0, 200.0)**. |
| `model_params.score_thresholds.thresholds`   | list[double] | [0.35, 0.35, 0.35, 0.35, 0.35, 0.35, 0.35, 0.35, 0.35, 0.35, 0.35, 0.35, 0.35, 0.35, 0.35, 0.35, 0.35, 0.35, 0.35, 0.35] | List of thresholds for each distance bucket. Expected size: **class_size \* upper_bounds** (ordered by class, then distance)                                                                                          |
