  ...
  const float * transform_array, int num_features, float * __restrict__ output_points)
{
  ...
  // 												transform_array[4]
  // * input_y + 												transform_array[8] * input_z + transform_array[12]; output_points[point_idx *
  // num_features + 1] = transform_array[1] * input_x + 												transform_array[5] * input_y +
  // 												transform_array[9]
  ...
  // transform_array[14]; output_points[point_idx * num_features + 3] = time_lag;
}
