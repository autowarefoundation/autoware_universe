...
public:
  ...
  double getDistanceInfluence(double distance) const;
  double getBEVAreaInfluence(double bev_area) const;

private:
  static constexpr double DISTANCE_BIN = 5.0;  // meter
  static constexpr double DISTANCE_BIN_INV = 1.0 / DISTANCE_BIN;
  ...
  static constexpr size_t DISTANCE_BIN_NUM =
    static_cast<size_t>(MAX_DISTANCE * DISTANCE_BIN_INV) + 1;
  static constexpr size_t BEV_AREA_BIN_NUM = 21;
