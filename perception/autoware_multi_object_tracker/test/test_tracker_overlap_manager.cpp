...
{
  auto obj = makeBboxObject(0.0, 0.0, 4.5, 1.8, mot::classes::Label::CAR, time);
  obj.kinematics.has_position_covariance = true;
  obj.pose_covariance[XYZRPY_COV_IDX::X_X] = 1.0;
  obj.pose_covariance[XYZRPY_COV_IDX::Y_Y] = 1.0;
  return obj;
}
