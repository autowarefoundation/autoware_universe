...
#ifndef ROI_3D_PROJECTOR_NODE_HPP_
#define ROI_3D_PROJECTOR_NODE_HPP_
...
class Roi3DProjectorNode : public rclcpp::Node
{
public:
  explicit Roi3DProjectorNode(const rclcpp::NodeOptions & node_options);
...
#endif  // ROI_3D_PROJECTOR_NODE_HPP_
