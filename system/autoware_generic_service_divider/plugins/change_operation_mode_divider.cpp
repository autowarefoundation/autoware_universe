...
public:
  ...
  {
    *static_cast<autoware_system_msgs::srv::ChangeOperationMode::Request *>(destination) =
      *static_cast<const autoware_system_msgs::srv::ChangeOperationMode::Request *>(source);
  }

  void copy_response(void * destination, const void * source) const override
  {
    *static_cast<autoware_system_msgs::srv::ChangeOperationMode::Response *>(destination) =
      *static_cast<const autoware_system_msgs::srv::ChangeOperationMode::Response *>(source);
  }
