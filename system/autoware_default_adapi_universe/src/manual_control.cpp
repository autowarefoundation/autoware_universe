...
: Node("manual_control", options), diag_updater_(std::make_unique<diagnostic_updater::Updater>(this))
{
  ...
  // Initialize diagnostics.
  {
    ...
    diag_heartbeat_ = std::make_unique<autoware_utils_diagnostics::TimeoutDiag>(params, *get_clock(), "heartbeat");
