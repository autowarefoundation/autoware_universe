...
private:
  ...
  /// Rate gate for the throttle mode: true once the throttle period has elapsed since the last
  /// relayed message, and unconditionally true when enable_throttle is false.
