...
private:
  ...
  autoware_auto_perception_msgs::msg::DetectedObjects::ConstSharedPtr object_recognition_;
  ...
  void onObjectRecognition(const autoware_auto_perception_msgs::msg::DetectedObjects::SharedPtr msg);
