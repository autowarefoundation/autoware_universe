...
| `over_velocity_validator.vehicle_vel_lpf_gain` | double | low-pass filter gain for filtering measured vehicle velocity [*] (time constant 2.0s at 30msec sampling period)       | 0.9836        |
| `over_velocity_validator.target_vel_lpf_gain`  | double | low-pass filter gain for filtering target velocity from trajectory [*] (time constant 2.0s at 30msec sampling period) | 0.9836        |
