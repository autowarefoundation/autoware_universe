...
graph TD
    ...
    click VadInputTopicData "https://github.com/autowarefoundation/autoware_universe/tree/main/planning/autoware_tensorrt_v../src/data_types_ros.hpp" "ROS data types header file"
    click VadOutputTopicData "https://github.com/autowarefoundation/autoware_universe/tree/main/planning/autoware_tensorrt_v../src/data_types_ros.hpp" "ROS data types header file"
    click VadInputData "https://github.com/autowarefoundation/autoware_universe/tree/main/planning/autoware_tensorrt_v../src/data_types_core.hpp" "Core data types header file"
    click VadOutputData "https://github.com/autowarefoundation/autoware_universe/tree/main/planning/autoware_tensorrt_v../src/data_types_core.hpp" "Core data types header file"
```
...
- Core data types (e.g. `VadInputData`) are in `data_types_core.hpp`
- ROS topic data types (e.g. `VadInputTopicData`) are in `data_types_ros.hpp`
