...
#ifndef DATA_TYPES_CORE_HPP_
#define DATA_TYPES_CORE_HPP_
...
{
  std::vector<std::array<float, 2>> trajectory;  // Dynamic timesteps x 2 coordinates (x, y)
