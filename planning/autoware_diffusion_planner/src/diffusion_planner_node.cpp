...
void DiffusionPlanner::set_up_params()
{
  ...
  params_.neighbor_vehicle_extra_margin_m =
    this->declare_parameter<double>("neighbor_vehicle_extra_margin_m", 0.0);
  ...
  [[maybe_unused]] const std::vector<rclcpp::Parameter> & parameters)
{
  using autoware_utils::update_param;
  {
    ...
    update_param<double>(
      parameters, "neighbor_vehicle_extra_margin_m", temp_params.neighbor_vehicle_extra_margin_m);
