...
| Is the object separated from the path by a guard rail?                                         | Pedestrian, Bicycle, Unknown | The module doesn't avoid objects behind a guard rail because they cannot enter the ego lane without crossing a physical boundary.                                                    | Never avoid it.                 |
