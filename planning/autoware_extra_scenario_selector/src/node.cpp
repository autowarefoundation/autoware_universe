...
std::string ExtraScenarioSelectorNode::selectScenarioByPosition()
{
...
void ExtraScenarioSelectorNode::updateCurrentScenario()
{
...
bool ExtraScenarioSelectorNode::isSwitchToWaypointFollowing(const bool is_stopped)
{
  const auto is_along_or_in_waypoint_zone =
    isAlongOrInWaypointZone(route_handler_->getLaneletMapPtr(), current_pose_->pose.pose);
...
bool ExtraScenarioSelectorNode::isSwitchToParking(const bool is_stopped)
{
  const auto is_in_parking_lot =
    isInParkingLot(route_handler_->getLaneletMapPtr(), current_pose_->pose.pose);
  const auto is_goal_in_lane =
...
bool ExtraScenarioSelectorNode::isSwitchToLaneDrivingFromParking()
{
...
bool ExtraScenarioSelectorNode::isSwitchToLaneDrivingFromWaypointFollowing(const bool is_stopped)
{
  const auto is_along_or_in_waypoint_zone =
    isAlongOrInWaypointZone(route_handler_->getLaneletMapPtr(), current_pose_->pose.pose);
  const auto is_along_lane = isAlongLane(route_handler_, current_pose_->pose.pose);
...
bool ExtraScenarioSelectorNode::isAutonomous() const
{
...
bool ExtraScenarioSelectorNode::isEmptyParkingTrajectory() const
{
...
void ExtraScenarioSelectorNode::onRoute(
...
void ExtraScenarioSelectorNode::onOdom(const nav_msgs::msg::Odometry::ConstSharedPtr msg)
{
  current_pose_ = msg;
...
bool ExtraScenarioSelectorNode::isDataReady()
{
  if (!current_pose_) {
...
void ExtraScenarioSelectorNode::updateData()
{
  {
    stop_watch.tic();
  }
...
void ExtraScenarioSelectorNode::onTimer()
{
  updateData();
...
void ExtraScenarioSelectorNode::onLaneDrivingTrajectory(
...
void ExtraScenarioSelectorNode::onParkingTrajectory(
  const autoware_planning_msgs::msg::Trajectory::ConstSharedPtr msg)
{
...
void ExtraScenarioSelectorNode::onWaypointFollowingTrajectory(
  const autoware_planning_msgs::msg::Trajectory::ConstSharedPtr msg)
{
...
void ExtraScenarioSelectorNode::publishTrajectory(
  const autoware_planning_msgs::msg::Trajectory::ConstSharedPtr msg)
{
...
ExtraScenarioSelectorNode::ExtraScenarioSelectorNode(const rclcpp::NodeOptions & node_options)
: Node("extra_scenario_selector", node_options),
  current_scenario_(autoware_internal_planning_msgs::msg::Scenario::EMPTY),
  ...
  is_waypoint_following_completed_(false)
{
  ...
  sub_lane_driving_trajectory_ = this->create_subscription<autoware_planning_msgs::msg::Trajectory>(
    ...
    std::bind(&ExtraScenarioSelectorNode::onLaneDrivingTrajectory, this, std::placeholders::_1));
  ...
  sub_parking_trajectory_ = this->create_subscription<autoware_planning_msgs::msg::Trajectory>(
    ...
    std::bind(&ExtraScenarioSelectorNode::onParkingTrajectory, this, std::placeholders::_1));
  ...
  sub_lanelet_map_ = this->create_subscription<autoware_map_msgs::msg::LaneletMapBin>(
    ...
    std::bind(&ExtraScenarioSelectorNode::onMap, this, std::placeholders::_1));

  sub_route_ = this->create_subscription<autoware_planning_msgs::msg::LaneletRoute>(
    "input/route", rclcpp::QoS{1}.transient_local(),
    std::bind(&ExtraScenarioSelectorNode::onRoute, this, std::placeholders::_1));
  ...
  timer_ = rclcpp::create_timer(
    this, get_clock(), period_ns, std::bind(&ExtraScenarioSelectorNode::onTimer, this));
