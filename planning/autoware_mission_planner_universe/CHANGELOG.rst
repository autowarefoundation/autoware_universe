...
* feat(mission_planner): print route state when set_route fails (`#10697 <https://github.com/TaikiYamada4/autoware_universe/issues/10697>`_)
  ...
  * without macro
  ---------
  Co-authored-by: Takagi, Isamu <43976882+isamu-takagi@users.noreply.github.com>
* fix(mission_planner): fix check if goal footprint is inside route (`#10681 <https://github.com/TaikiYamada4/autoware_universe/issues/10681>`_)
