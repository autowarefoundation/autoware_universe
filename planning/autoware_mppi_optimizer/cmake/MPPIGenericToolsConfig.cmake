...
function(mppi_detect_cuda_arch default_arch_out)
  execute_process(
  ...
  if (_cap MATCHES "^([0-9]+)\\.([0-9]+)")
    set(${default_arch_out} "${CMAKE_MATCH_1}${CMAKE_MATCH_2}" PARENT_SCOPE)
  else()
    set(${default_arch_out} "86" PARENT_SCOPE)
  endif()
endfunction()

# CMake 3.18+ supports CMAKE_CUDA_ARCHITECTURES; native requires 3.24+.
  ...
  if (NOT DEFINED MPPI_ARCH_FLAGS)
    if ("${MPPI_CUDA_ARCH_LIST}" STREQUAL "")
      if (CMAKE_VERSION VERSION_LESS 3.24)
        mppi_detect_cuda_arch(_mppi_default_arch)
        set(CMAKE_CUDA_ARCHITECTURES "${_mppi_default_arch}")
      else()
