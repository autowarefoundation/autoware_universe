 ...
 */
#ifndef MPPI__FEEDBACK_CONTROLLERS__CCM__CCM_H_
#define MPPI__FEEDBACK_CONTROLLERS__CCM__CCM_H_
...
public:
  ...
  explicit LinearCCMGPU(cudaStream_t stream = 0) : GPUFeedbackController<LinearCCMGPU<DYN_T>, DYN_T, GPUState>(stream)
  {
  }
};
...
public:
  ...
  // TODO(tier4): Replace with some call to Dynamics
...
#endif  // MPPI__FEEDBACK_CONTROLLERS__CCM__CCM_H_
